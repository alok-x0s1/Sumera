					...
					<div className="hidden lg:relative lg:block lg:p-12">
						...
						<div className="mt-4 leading-relaxed text-white/90">
							...
							<p className="mt-4 leading-relaxed text-white/90">
								Our personal finance app helps you keep track of
								your spending, manage budgets, and achieve your
								financial goals effortlessly. Get insights that
						...
						<div className="relative -mt-16 mb-4 block lg:hidden">
							...
							<div className="mt-4 leading-relaxed text-gray-500">
								...
								<p className="mt-4 leading-relaxed text-gray-500">
									Our personal finance app helps you keep
									track of your spending, manage budgets, and
									achieve your financial goals effortlessly.
									Get insights that help you save more and
									spend less.
								</p>
							</div>
						</div>
